      ...
      >
        ...
        <div className="w-full pt-2 border-t border-slate-100 space-y-1">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white font-bold py-3 px-3 rounded-2xl transition-all shadow-md hover:shadow-lg hover:scale-[1.01] cursor-pointer"
          >
